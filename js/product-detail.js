...
if (!product) {
  ...
  document.title = `${product.name} | Clad Whale`;
  const images = product.images?.length ? product.images : ["../assets/images/logo.png"];
  root.innerHTML = `
    <div>
    ...
    <div class="summary-card">
      ...
      <p class="muted mt-5">${product.description || "Premium Clad Whale piece with a flattering fit and polished finish."}</p>
      <div class="mt-6">
  ...
  localStorage.setItem("cladwhale_cart", JSON.stringify(cart));
